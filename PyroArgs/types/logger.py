...
class Logger:
    def __init__(
        ...
        self.permissions_error_message = (
            'Permission error: User "{user}" does not have '
            'permission level "{level}" to execute command "{command}".'
        )
    ...
    def setup_logs(
            self,
            before_use_command: bool = True,
            after_use_command: bool = True,
            missing_argument_error: bool = True,
            argument_type_error: bool = True,
            command_error: bool = True,
            permissions_error: bool = True
    ) -> None:
    ...
    async def _trigger_permissions_error(
            self,
            message: Message,
